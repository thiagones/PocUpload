...
function App() {
  ...
  const uploadChunk = async (chunk) => {
    try {
      const response = await axios.post("https://localhost:5001/Upload/UploadChunks", chunk, {
        params: {
          id: counter,
          fileName: fileGuid,
        },
  ...
  const uploadCompleted = async () => {
    ...
    const response = await axios.post("https://localhost:5001/Upload/UploadComplete", {}, {
      params: {
        fileName: fileGuid,
      },
      data: formData,
